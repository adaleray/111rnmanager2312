...
module.exports.operate = ({msg, client, uye, author, args, db, cfg}) => {
  ...
  msg.channel.send({embed:{description:`**${uye.user.tag}** adlı üye ${msg.author} tarafından **${reason}** sebebiyle sunucudan yasaklandı`, color:Math.floor(Math.random()*(0xFFFFFF + 1)), timestamp: new Date()}});
